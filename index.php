	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Curious Learners</h1>
			</div>
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="p.html">Assistant</a></li>
					<li> <a href="paresh11.html">Chatbot</a></li>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/profile.php?id=100057542552970" class="fa fa-facebook"></a>
								<a href="#" class="fa fa-twitter"></a>
								<a href="https://www.instagram.com/im_paresh_rajput" class="fa fa-instagram"></a>
								<a href="#" class="fa fa-reddit"></a>
								<a href="https://www.linkedin.com/in/paresh-rajput-66b12022b" class="fa fa-linkedin"></a>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/paresh.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Paresh Rajput</h4>
							...
							<div class="team-member text-center">
								<img src="img/bhushan1.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Bhushan Rajput</h4>
									<h4 class="team-member-designation">CEO</h4>
									<ul class="social-list">
							...
							<div class="team-member text-center">
								<img src="img/tejas.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
							...
							<div class="team-member text-center">
								<img src="img/paresh.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Pravin solnakhi</h4>
							...
							<div class="team-member text-center">
								<img src="img/paresh" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Jayvant patil</h4>
									<h4 class="team-member-designation">ceo</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
											Curious Learners is an online E-learning website <br>
